        ...
        <form action="../app/classes/add_job.php" method="POST" class="u-clearfix u-form-spacing-20 u-inner-form" style="padding: 10px" source="custom" name="form">
          ...
          <div class="u-form-group u-form-select u-form-group-2">
            ...
            <div class="u-form-select-wrapper">
              <select id="select-ce55" name="truck_id" class="u-border-1 u-border-custom-color-1 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-raleway u-input u-input-rectangle u-input-2">
          ...
          <div class="u-form-group u-form-select u-form-group-2">
            <label for="select-ce55" class="u-form-control-hidden u-label"></label>
            <div class="u-form-select-wrapper">
              <select id="select-ce55" name="departure_id" class="u-border-1 u-border-custom-color-1 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-raleway u-input u-input-rectangle u-input-2">
          ...
          <div class="u-form-group u-form-select u-form-group-2">
            <label for="select-ce55" class="u-form-control-hidden u-label"></label>
            <div class="u-form-select-wrapper">
              <select id="select-ce55" name="destination_id" class="u-border-1 u-border-custom-color-1 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-raleway u-input u-input-rectangle u-input-2">
          ...
          <div class="u-form-group u-form-message">
            ...
            <textarea placeholder="Evidence" rows="4" cols="50" id="message-3b9a" name="evidence" class="u-border-1 u-border-custom-color-1 u-border-no-left u-border-no-right u-border-no-top u-custom-font u-font-raleway u-input u-input-rectangle u-input-3" required=""></textarea>
          </div>
          <br>
