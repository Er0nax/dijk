      ...
      <div class="u-form u-form-1">
        <form action="../app/login_register/register.php" method="POST" class="u-clearfix u-form-spacing-20 u-inner-form" style="padding: 10px" source="custom" name="form">
          ...
          <div class="u-form-group u-form-group-3">
            ...
            <input type="text" placeholder="Discord" id="text-8b2a" name="discord" class="u-border-1 u-border-no-left u-border-no-right u-border-no-top u-border-palette-1-base u-custom-font u-font-raleway u-input u-input-rectangle u-input-1">
          </div>
          <br>
