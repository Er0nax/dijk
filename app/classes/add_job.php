...
$sql_insert_jobs = "INSERT INTO jobs (user_id, username, departure_id, destination_id, truck_id, cargo, income, distance, evidence) VALUES ('$user_id', '$username', '$departure_id', '$destination_id', '$truck_id', '$cargo', '$income', '$distance', '$evidence')";
