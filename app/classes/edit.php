...
$sql = "UPDATE users SET password='$password', discord='$discord', truckersmp='$truckersmp', information='$information', user_pb='$user_pb', status_color='$status_color', updated_at='$timestamp' WHERE username='$editeduser'";
